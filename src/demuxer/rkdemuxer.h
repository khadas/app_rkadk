...
int rkdemuxer_read_video_duration(void *demuxer_cfg, int64_t *duration, int32_t *frame_count);
int rkdemuxer_read_audio_duration(void *demuxer_cfg, int64_t *duration, int32_t *frame_count);
