...
typedef struct {
  bool bUsed;
  RKADK_VOID *pHandle;
  RKADK_MEDIA_AENC_DATA_PROC_FUNC cbList;
} RKADK_GET_AENC_CB_ATTR_S;

typedef struct {
  bool bUsed;
  RKADK_VOID *pHandle;
  RKADK_MEDIA_VENC_DATA_PROC_FUNC cbList;
} RKADK_GET_VENC_CB_ATTR_S;
...
static const struct RKADK_FORMAT_MAP fromat[] = {
    ...
    {RKADK_FMT_RGB565, RK_FMT_RGB565},
    {RKADK_FMT_BGR565, RK_FMT_BGR565},
...
static RKADK_U32 RKADK_MPI_VO_CreateLayDev(RKADK_S32 s32VoLay, RKADK_S32 s32VoDev,
  ...
  if (!g_bVoLayerDevInitCnt[s32VoLay][s32VoDev]) {
    ...
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_SetPubAttr[%d] failed[%x]", s32VoDev, ret);
      return ret;
    }

    ret = RK_MPI_VO_Enable(s32VoDev);
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_Enable[%d] failed[%x]", s32VoDev, ret);
      return ret;
    }

    ret = RK_MPI_VO_GetPubAttr(s32VoDev, pstVoPubAttr);
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_GetPubAttr[%d] failed[%x]", s32VoDev, ret);
      return ret;
    }
    ...
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_SetLayerAttr[%d] failed[%x]", s32VoLay, ret);
      return ret;
    }
    ...
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_EnableLayer[%d] failed[%x]", s32VoLay, ret);
      return ret;
    }
  } else {
    ret = RK_MPI_VO_GetPubAttr(s32VoDev, pstVoPubAttr);
...
static RKADK_U32 RKADK_MPI_VO_DestroyLayDev(RKADK_S32 s32VoLay, RKADK_S32 s32VoDev) {
  ...
  if (g_bVoLayerDevInitCnt[s32VoLay][s32VoDev] == 1) {
    ...
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_DisableLayer[%d] failed[%x]", s32VoLay, ret);
      return ret;
    }

    ret = RK_MPI_VO_Disable(s32VoDev);
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_Disable[%d] failed[%x]", s32VoDev, ret);
      return ret;
    }

    ret = RK_MPI_VO_UnBindLayer(s32VoLay, s32VoDev);
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_UnBindLayer[%d, %d] failed[%x]", s32VoLay, s32VoDev, ret);
      return ret;
    }
  }
...
static RKADK_U32 RKADK_MPI_VPSS_CreateGrp(RKADK_S32 s32VpssGrp, VPSS_GRP_ATTR_S *pstVpssGrpAttr) {
  ...
  if (!g_bVpssGrpInitCnt[s32VpssGrp]) {
    ...
    if (ret) {
      ...
      RKADK_LOGE("RK_MPI_VPSS_CreateGrp[%d] failed[%x]", s32VpssGrp, ret);
      return ret;
    }
    ...
    if (ret) {
      ...
      RK_MPI_VPSS_DestroyGrp(s32VpssGrp);
      RKADK_LOGE("RK_MPI_VPSS_StartGrp[%d] failed[%x]", s32VpssGrp, ret);
      return ret;
    }

    ret = RK_MPI_VPSS_ResetGrp(s32VpssGrp);
    if (ret) {
      RKADK_LOGE("RK_MPI_VPSS_ResetGrp[%d] failed[%x]", s32VpssGrp, ret);
    }

    ret = RK_MPI_VPSS_SetVProcDev(s32VpssGrp, (VIDEO_PROC_DEV_TYPE_E)pstCommCfg->vpss_devcie);
    if (ret) {
      RKADK_LOGE("RK_MPI_VPSS_SetVProcDev[%d] failed[%x]", s32VpssGrp, ret);
      RK_MPI_VPSS_StopGrp(s32VpssGrp);
      RK_MPI_VPSS_DestroyGrp(s32VpssGrp);
      return ret;
    }
...
RKADK_S32 RKADK_MPI_AI_DeInit(AUDIO_DEV aiDevId, RKADK_S32 s32AiChnId,
  ...
  if (0 == s32InitCnt) {
    ...
    if (enMode != RKADK_VQE_MODE_BUTT) {
      ...
      if (ret)
        RKADK_LOGE("AI[%d, %d] DisableVqe failed[%x]", aiDevId, s32AiChnId, ret);
    }
...
RKADK_S32 RKADK_MPI_AENC_Init(RKADK_S32 s32AencChnId,
  ...
  if (0 == g_stMediaCtx.stAencInfo[i].s32InitCnt) {
    ...
    if (ret) {
      RKADK_LOGE("Create AENC[%d] failed[%x]", s32AencChnId, ret);
      goto exit;
    }
...
RKADK_S32 RKADK_MPI_AENC_DeInit(RKADK_S32 s32AencChnId) {
  ...
  if (0 == s32InitCnt) {
    ...
    if (ret) {
      RKADK_LOGE("Destroy AENC[%d] failed[%x]", s32AencChnId, ret);
      goto exit;
    }
...
RKADK_S32 RKADK_MPI_VI_Init(RKADK_U32 u32CamId, RKADK_S32 s32ViChnId,
  ...
  if (0 == g_stMediaCtx.stViInfo[i].s32InitCnt) {
    ...
    if (ret == RK_ERR_VI_NOT_CONFIG) {
      ...
      if (ret) {
        RKADK_LOGE("RK_MPI_VI_SetDevAttr[%d] failed[%x]", u32CamId, ret);
        goto exit;
      }
    } else {
    ...
    if (ret) {
      ...
      if (ret) {
        RKADK_LOGE("RK_MPI_VI_EnableDev[%d] failed[%x]", u32CamId, ret);
        goto exit;
      }
      ...
      if (ret) {
        RKADK_LOGE("RK_MPI_VI_SetDevBindPipe[%d] failed[%x]", u32CamId, ret);
    ...
    if (ret) {
      RKADK_LOGE("Set VI[%d, %d] attribute failed[%x]", u32CamId, s32ViChnId, ret);
      RK_MPI_VI_DisableDev(u32CamId);
      goto exit;
    }
    ...
    if (ret) {
      RKADK_LOGE("Create VI[%d, %d] failed[%x]", u32CamId, s32ViChnId, ret);
      RK_MPI_VI_DisableDev(u32CamId);
      goto exit;
    }
...
RKADK_S32 RKADK_MPI_VI_DeInit(RKADK_U32 u32CamId, RKADK_S32 s32ViChnId) {
  ...
  if (0 == s32InitCnt) {
    ...
    if (ret) {
      RKADK_LOGE("Destory VI[%d, %d] failed[%x]", u32CamId, s32ViChnId, ret);
      goto exit;
    }
...
RKADK_S32 RKADK_MPI_VI_QueryCameraStatus(RKADK_U32 u32CamId) {
  ...
  if (ret == RK_SUCCESS) {
    if (!stDevStatus.bProbeOk) {
      RKADK_LOGE("Camera[%d] sensor probe failed[%x]", u32CamId, ret);
      return -1;
    }
  }
...
RKADK_S32 RKADK_MPI_VPSS_Init(RKADK_S32 s32VpssGrp, RKADK_S32 s32VpssChn,
  ...
  if (0 == g_stMediaCtx.stVpssInfo[i].s32InitCnt) {
    ...
    if (ret) {
      RKADK_LOGE("RKADK_MPI_VPSS_CreateGrp[%d] failed [%x]", s32VpssGrp, ret);
      goto exit;
    }

    ret = RK_MPI_VPSS_SetChnAttr(s32VpssGrp, s32VpssChn, pstVpssChnAttr);
    if (ret) {
      RKADK_LOGE("RK_MPI_VPSS_SetChnAttr[%d, %d] failed with[%x]", s32VpssGrp, s32VpssChn, ret);
      goto exit;
    }

    ret = RK_MPI_VPSS_EnableChn(s32VpssGrp, s32VpssChn);
    if (ret) {
      RKADK_LOGE("RK_MPI_VPSS_EnableChn[%d, %d] failed[%x]", s32VpssGrp, s32VpssChn, ret);
      goto exit;
    }
...
RKADK_S32 RKADK_MPI_VPSS_DeInit(RKADK_S32 s32VpssGrp, RKADK_S32 s32VpssChn) {
  ...
  if (i < 0) {
    RKADK_LOGE("not find matched index[%d] s32VpssGrp[%d] s32ChnId[%d]", i, s32VpssGrp, s32VpssChn);
    goto exit;
  }
  ...
  if (0 == s32InitCnt) {
    ...
    if (ret) {
      RKADK_LOGE("Destory VPSS[%d, %d] failed[%x]", s32VpssGrp, s32VpssChn, ret);
      goto exit;
    }
...
RKADK_S32 RKADK_MPI_VO_Init(RKADK_S32 s32VoLay, RKADK_S32 s32VoDev, RKADK_S32 s32VoChn,
  ...
  if (0 == g_stMediaCtx.stVoInfo[i].s32InitCnt) {
    ...
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_SetChnAttr[%d, %d] failed[%x]", s32VoLay, s32VoChn, ret);
      goto exit;
    }

    ret = RK_MPI_VO_EnableChn(s32VoLay, s32VoChn);
    if (ret) {
      RKADK_LOGE("RK_MPI_VO_EnableChn[%d, %d] failed[%x]", s32VoLay, s32VoChn, ret);
      goto exit;
    }
...
RKADK_S32 RKADK_MPI_VO_DeInit(RKADK_S32 s32VoLay, RKADK_S32 s32VoDev, RKADK_S32 s32VoChn) {
  ...
  if (i < 0) {
    RKADK_LOGE("not find matched index[%d] s32ChnId[%d, %d]", i, s32VoDev, s32VoChn);
    goto exit;
  }
  ...
  if (0 == s32InitCnt) {
    ...
    if (ret) {
      RKADK_LOGE("Destory Vo Chn[%d, %d] failed[%x]", s32VoLay, s32VoChn, ret);
      goto exit;
    }
...
static void *RKADK_MEDIA_GetAencMb(void *params) {
  ...
  while (pstMediaInfo->stGetAencMBAttr.bGetBuffer) {
    ...
    if (ret == RK_SUCCESS) {
      ...
      if (ret)
        RKADK_LOGE("RK_MPI_AENC_ReleaseStream[%d] failed[%x]", pstMediaInfo->s32ChnId, ret);
    }
  }
...
RKADK_S32 RKADK_MEDIA_GetAencBuffer(MPP_CHN_S *pstChn,
  ...
  pstMediaInfo->stGetAencMBAttr.cb[j].pHandle = pHandle;
...
RKADK_MEDIA_StopGetAencBuffer(MPP_CHN_S *pstChn,
  ...
  for (int j = 0; j < RKADK_MEDIA_AENC_MAX_CNT; j++) {
    if (pstMediaInfo->stGetAencMBAttr.cb[j].bUsed
        && pstMediaInfo->stGetAencMBAttr.cb[j].cbList == pfnDataCB
        && pstMediaInfo->stGetAencMBAttr.cb[j].pHandle == pHandle) {
      RKADK_LOGD("remove stAencInfo[%d] cb[%d] cbList s32GetCnt[%d]", i, j, pstMediaInfo->stGetAencMBAttr.s32GetCnt);
      pstMediaInfo->stGetAencMBAttr.cb[j].cbList = NULL;
      pstMediaInfo->stGetAencMBAttr.cb[j].pHandle = NULL;
      pstMediaInfo->stGetAencMBAttr.cb[j].bUsed = false;
      pstMediaInfo->stGetAencMBAttr.s32GetCnt--;
      break;
    }
  }
...
static void *RKADK_MEDIA_GetVencMb(void *params) {
  ...
  while (pstMediaInfo->stGetVencMBAttr.bGetBuffer) {
    ...
    if (ret == RK_SUCCESS) {
      ...
      if (ret)
        RKADK_LOGE("RK_MPI_VENC_ReleaseStream[%d] failed[%x]", pstMediaInfo->s32ChnId, ret);
    } else {
  ...
  RKADK_LOGI("Exit get venc[%d] mb thread", pstMediaInfo->s32ChnId);
  return NULL;
}
...
RKADK_S32 RKADK_MEDIA_GetVencBuffer(MPP_CHN_S *pstChn,
  ...
  pstMediaInfo->stGetVencMBAttr.cb[j].pHandle = pHandle;
  ...
  if (ret) {
    RKADK_LOGE("Create get venc mb[%d] thread failed[%d]", pstChn->s32ChnId, ret);
    goto exit;
  }
...
RKADK_MEDIA_StopGetVencBuffer(RKADK_U32 u32CamId, MPP_CHN_S *pstChn, bool bIsAovMode,
  ...
  for (int j = 0; j < RKADK_MEDIA_VENC_MAX_CNT; j++) {
    if (pstMediaInfo->stGetVencMBAttr.cb[j].bUsed
        && pstMediaInfo->stGetVencMBAttr.cb[j].cbList == pfnDataCB
        && pstMediaInfo->stGetVencMBAttr.cb[j].pHandle == pHandle) {
      RKADK_LOGD("remove stVencInfo[%d] cb[%d] cbList s32GetCnt[%d]", i, j, pstMediaInfo->stGetVencMBAttr.s32GetCnt);
      pstMediaInfo->stGetVencMBAttr.cb[j].cbList = NULL;
      pstMediaInfo->stGetVencMBAttr.cb[j].pHandle = NULL;
      pstMediaInfo->stGetVencMBAttr.cb[j].bUsed = false;
      pstMediaInfo->stGetVencMBAttr.s32GetCnt--;
      break;
    }
  }
  ...
  if (!pstMediaInfo->stGetVencMBAttr.s32GetCnt) {
    ...
    if (pstMediaInfo->stGetVencMBAttr.tid) {
      ...
      if (ret)
        RKADK_LOGE("ChnId[%d] exit get venc mb thread failed!", pstMediaInfo->s32ChnId);
      else
        RKADK_LOGI("ChnId[%d] exit get venc mb thread ok", pstMediaInfo->s32ChnId);
...
RKADK_S32 RKADK_MPI_SYS_UnBind(const MPP_CHN_S *pstSrcChn,
  ...
  if (i < 0) {
    RKADK_MUTEX_UNLOCK(g_stMediaCtx.bindMutex);
    RKADK_LOGE("not find matched index[%d] src[%d, %d, %d], dest[%d, %d, %d]", i,
                pstSrcChn->s32DevId, pstSrcChn->enModId, pstSrcChn->s32ChnId,
                pstDestChn->s32DevId, pstDestChn->enModId, pstDestChn->s32ChnId);
    return -1;
  }
...
int RKADK_MEDIA_VideoReset(RKADK_U32 u32CamId, RKADK_PRAAM_VI_ATTR_S vi_attr, RKADK_PARAM_VENC_ATTR_S attribute) {
  ...
  bUseVpss = RKADK_MEDIA_VideoIsUseVpss(u32CamId, false, NULL, vi_attr, attribute);
